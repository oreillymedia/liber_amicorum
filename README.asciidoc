...
The *tools* section attemplts to map the key tools.  The goal is not so much to provide an exhautive reference, but more to give a good overview of what the tool is, who the heavyweights in the field are, and list some interesting work. Here are a few examples:
